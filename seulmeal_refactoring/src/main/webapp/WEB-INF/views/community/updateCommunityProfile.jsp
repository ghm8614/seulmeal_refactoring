...
<body>
	...
	<div class="container">
		...
		<form class="profile-form" action="/api/v1/community/profile" method="POST" enctype="multipart/form-data">
			...
			<!-- 모달창 실행 버튼 -->
			<button id="updateProfileImageModal_Btn" type="button"
				class="btn btn-primary" data-toggle="modal"
				data-target="#updateProfileImageModal">프로필 이미지 변경</button>
			<!-- 모달창 include -->
			<jsp:include page="updateCommunityProfileImageModal.jsp" />

			<!-- 닉네임 -->
			<div class="form-group">
				<label for="inputNickName" class="col-sm-5 control-label"
					style="font-size: 20px;">닉네임</label>
				<div class="col-sm-7">
					<input type="text" name="nickName" required maxLength=6
						onInput="maxLengthCheck(this)" onKeyUp="inputDataCheck(this.id)"
						style="width: 605px;" id="nickName" class="form-control mx-sm-3"
						value="${sessionScope.user.nickName}"> <small
						id="nickNameHelpInline" style="margin-left: 3px;"
						class="text-muted col-sm-7"> 5글자 이상 입력해주세요. </small>
				</div>
			</div>

			<!-- 상태메시지 -->
			<div class="form-group">
				<label for="inputProfileMessage" class="col-sm-5 control-label"
					style="font-size: 20px;">상태메시지</label>
				<div class="col-sm-7">
					<input type="text" name="profileMessage" required maxLength=40
						onInput="maxLengthCheck(this)" onKeyUp="inputDataCheck(this.id)"
						style="width: 605px;" id="profileMessage"
						class="form-control mx-sm-3" aria-describedby="nickNameHelpInline"
						value="${sessionScope.user.profileMessage}"> <small
						id="profileMsgHelpInline" style="margin-left: 3px;"
						class="text-muted col-sm-7"> 40자 이내로 입력해주세요. </small>
				</div>
			</div>
			...
			<div class="button-div">
				<button id="updateProfileBtn" type="button"
					onclick="updateProfile()" class="btn btn-primary">수정</button>
