...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="updateForm" action="/api/v1/community/posts/${post.postNo}"
				...
				<div>
					...
					<c:forEach var="attachments" items="${post.attachments}">
						<div data-value="${attachments.attachmentsNo}">${attachments.attachmentName}
							<button type="button" onclick="deleteAttachment(this)"
	...
	<script>
		...
		function updateBtn() {
			...
			if (title === "") {
				toastr.error("제목을 올바르게 입력하세요", "제목 에러", {
					timeOut : 10000
				})
				return;
			}
			...
			if (content === "") {
				toastr.error("내용을 올바르게 입력하세요", "내용 에러", {
					timeOut : 10000
				})
				return;
			}
